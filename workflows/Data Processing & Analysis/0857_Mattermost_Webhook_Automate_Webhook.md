...
## 🚀 What It Does
This workflow automates a process involving mattermost, jira, pagerDuty.
...
4. **Step 3: Jira (jira)** - This step performs a key action in the workflow.
5. **Step 4: PagerDuty (pagerDuty)** - This step performs a key action in the workflow.
...
2. **Customize Core Logic:** Review "Mattermost" and "Webhook" for IDs, table names, and URLs.
