...
3. **Step 2: Set link to audio (set)** - This step performs a key action in the workflow.
4. **Step 3: Sticky Note (stickyNote)** - This step performs a key action in the workflow.
5. **Step 4: Sticky Note1 (stickyNote)** - This step performs a key action in the workflow.
6. **Step 5: AssemblyAI - Transcribe (httpRequest)** - This step performs a key action in the workflow.
7. **Step 6: If (if)** - This step performs a key action in the workflow.
8. **Step 7: AssemblyAI - Get transcription (httpRequest)** - This step performs a key action in the workflow.
9. **Step 8: OpenAI - Analyze call (httpRequest)** - This step performs a key action in the workflow.
10. **Step 9: Set vars (set)** - This step performs a key action in the workflow.
11. **Step 10: Create record (supabase)** - This step performs a key action in the workflow.
