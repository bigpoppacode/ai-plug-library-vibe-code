...
## ⚙️ How It Works
1. **On new invoice in Clockify (webhook)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On new invoice in Clockify" and "Note" and update any placeholder IDs, table names, or URLs to match your specific needs.
