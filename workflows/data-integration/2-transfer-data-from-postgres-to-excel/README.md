...
## ⚙️ How It Works
1. **Run Query (postgres)**: The workflow starts or proceeds with this step.
2. **Spreadsheet File (spreadsheetFile)**: The workflow starts or proceeds with this step.
3. **Write Binary File (writeBinaryFile)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Run Query" and "Write Binary File" and update any placeholder IDs, table names, or URLs to match your specific needs.
