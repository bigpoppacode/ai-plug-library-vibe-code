...
2. **Read Binary Files (readBinaryFiles)**: The workflow starts or proceeds with this step.
3. **Extract binary data (code)**: The workflow starts or proceeds with this step.
4. **XML to JSON (xml)**: The workflow starts or proceeds with this step.
5. **Item Lists (itemLists)**: The workflow starts or proceeds with this step.
6. **Add new records (mySql)**: The workflow starts or proceeds with this step.
