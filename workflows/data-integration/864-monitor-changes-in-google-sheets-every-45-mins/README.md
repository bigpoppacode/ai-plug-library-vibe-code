...
## ⚙️ How It Works
1. **Send message (mattermost)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Send message" and "Execute every 45 mins" and update any placeholder IDs, table names, or URLs to match your specific needs.
