...
4. **Read CSV (spreadsheetFile)**: The workflow starts or proceeds with this step.
5. **Assign source file name (set)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "When clicking "Execute Workflow"" and "Assign source file name" and update any placeholder IDs, table names, or URLs to match your specific needs.
