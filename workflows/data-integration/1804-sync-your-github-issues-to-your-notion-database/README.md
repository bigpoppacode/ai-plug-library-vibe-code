...
## ⚙️ How It Works
1. **Trigger on issues (githubTrigger)**: The workflow starts or proceeds with this step.
2. **IF (if)**: The workflow starts or proceeds with this step.
3. **Create database page (notion)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Create database page" and "Trigger on issues" and update any placeholder IDs, table names, or URLs to match your specific needs.
