...
3. **Google Cloud Firestore (googleFirebaseCloudFirestore)**: The workflow starts or proceeds with this step.
4. **Set1 (set)**: The workflow starts or proceeds with this step.
5. **Google Cloud Firestore1 (googleFirebaseCloudFirestore)**: The workflow starts or proceeds with this step.
6. **Google Cloud Firestore2 (googleFirebaseCloudFirestore)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Google Cloud Firestore2" and update any placeholder IDs, table names, or URLs to match your specific needs.
