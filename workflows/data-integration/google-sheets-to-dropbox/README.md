...
## ⚙️ How It Works
1. **Read Sheet (googleSheets)**: The workflow starts or proceeds with this step.
2. **Convert to XLS (spreadsheetFile)**: The workflow starts or proceeds with this step.
3. **Upload Dropbox (dropbox)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Read Sheet" and "Trigger all 15 min" and update any placeholder IDs, table names, or URLs to match your specific needs.
