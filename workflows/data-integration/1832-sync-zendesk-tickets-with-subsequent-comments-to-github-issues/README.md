...
## ⚙️ How It Works
1. **Get ticket (zendesk)**: The workflow starts or proceeds with this step.
2. **Determine (function)**: The workflow starts or proceeds with this step.
3. **IF (if)**: The workflow starts or proceeds with this step.
4. **Create comment on existing issue (github)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Get ticket" and "On new Zendesk ticket" and update any placeholder IDs, table names, or URLs to match your specific needs.
