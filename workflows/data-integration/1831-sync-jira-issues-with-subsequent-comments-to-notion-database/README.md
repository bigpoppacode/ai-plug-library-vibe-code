...
## ⚙️ How It Works
1. **On issues created/updated/deleted (jiraTrigger)**: The workflow starts or proceeds with this step.
2. **Lookup table (code)**: The workflow starts or proceeds with this step.
3. **IF (if)**: The workflow starts or proceeds with this step.
4. **Create database page (notion)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Create database page" and "Update issue" and update any placeholder IDs, table names, or URLs to match your specific needs.
