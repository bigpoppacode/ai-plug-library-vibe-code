...
## ⚙️ How It Works
1. **Read from Google Sheets (googleSheets)**: The workflow starts or proceeds with this step.
2. **Build HTML (function)**: The workflow starts or proceeds with this step.
3. **Respond to Webhook (respondToWebhook)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Read from Google Sheets" and "Webhook" and update any placeholder IDs, table names, or URLs to match your specific needs.
