...
## ⚙️ How It Works
1. **Get journal reply (telegramTrigger)**: The workflow starts or proceeds with this step.
2. **Parse message (functionItem)**: The workflow starts or proceeds with this step.
3. **Add entry to sheet (googleSheets)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Add entry to sheet" and "Parse message" and update any placeholder IDs, table names, or URLs to match your specific needs.
