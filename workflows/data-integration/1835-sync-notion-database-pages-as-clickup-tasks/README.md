...
## ⚙️ How It Works
1. **On updated database page (notionTrigger)**: The workflow starts or proceeds with this step.
2. **Update an existing task (clickUp)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On updated database page" and "Update the status of found database page" and update any placeholder IDs, table names, or URLs to match your specific needs.
