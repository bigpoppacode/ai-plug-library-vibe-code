...
3. **Google Calendar (googleCalendar)**: The workflow starts or proceeds with this step.
4. **IF Zoom meeting (if)**: The workflow starts or proceeds with this step.
5. **Zoom (zoom)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Cron Once a Day" and update any placeholder IDs, table names, or URLs to match your specific needs.
