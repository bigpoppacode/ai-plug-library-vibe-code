...
## ⚙️ How It Works
1. **On file upload (googleDriveTrigger)**: The workflow starts or proceeds with this step.
2. **Create database page (notion)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On file upload" and "Create database page" and update any placeholder IDs, table names, or URLs to match your specific needs.
