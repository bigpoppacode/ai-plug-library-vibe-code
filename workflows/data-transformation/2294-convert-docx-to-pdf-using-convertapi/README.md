...
2. **Download File (httpRequest)**: The workflow starts or proceeds with this step.
3. **File conversion (httpRequest)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "When clicking ‘Test workflow’" and "File conversion" and update any placeholder IDs, table names, or URLs to match your specific needs.
