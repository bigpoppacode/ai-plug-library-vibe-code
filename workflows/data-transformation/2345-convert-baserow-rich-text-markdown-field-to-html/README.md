...
## ⚙️ How It Works
1. **Get single record from baserow (baserow)**: The workflow starts or proceeds with this step.
2. **Convert markdown to HTML (single) (markdown)**: The workflow starts or proceeds with this step.
3. **Update single record in baserow (baserow)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Get single record from baserow" and "Sticky Note" and update any placeholder IDs, table names, or URLs to match your specific needs.
