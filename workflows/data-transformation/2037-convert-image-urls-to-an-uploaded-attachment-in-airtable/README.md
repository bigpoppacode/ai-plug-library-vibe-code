...
2. **Get all records with an image URL (airtable)**: The workflow starts or proceeds with this step.
3. **Update attachment field with images (airtable)**: The workflow starts or proceeds with this step.
