...
2. **TableName (set)**: The workflow starts or proceeds with this step.
3. **Postgres (postgres)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "When clicking "Execute Workflow"" and "Postgres" and update any placeholder IDs, table names, or URLs to match your specific needs.
