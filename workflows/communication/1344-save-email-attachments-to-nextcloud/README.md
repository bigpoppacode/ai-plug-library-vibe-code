...
2. **Map each attachment (function)**: The workflow starts or proceeds with this step.
3. **Nextcloud (nextCloud)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "IMAP Email" and "Map each attachment" and update any placeholder IDs, table names, or URLs to match your specific needs.
