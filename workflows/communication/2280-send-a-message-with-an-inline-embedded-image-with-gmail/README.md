...
2. **Message settings (set)**: The workflow starts or proceeds with this step.
3. **Get image (httpRequest)**: The workflow starts or proceeds with this step.
4. **Convert image to base64 (extractFromFile)**: The workflow starts or proceeds with this step.
5. **Compose message (set)**: The workflow starts or proceeds with this step.
6. **Send message (httpRequest)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "When clicking "Test workflow"" and "Sticky Note3" and update any placeholder IDs, table names, or URLs to match your specific needs.
