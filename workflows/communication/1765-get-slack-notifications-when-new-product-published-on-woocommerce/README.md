...
## ⚙️ How It Works
1. **On product creation (wooCommerceTrigger)**: The workflow starts or proceeds with this step.
2. **If URL has /product/ (if)**: The workflow starts or proceeds with this step.
3. **Send message to slack (slack)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "If URL has /product/" and "On product creation" and update any placeholder IDs, table names, or URLs to match your specific needs.
