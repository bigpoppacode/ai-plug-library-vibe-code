...
2. **Fetch API details (httpRequest)**: The workflow starts or proceeds with this step.
3. **Get mailboxes (httpRequest)**: The workflow starts or proceeds with this step.
4. **Format results (set)**: The workflow starts or proceeds with this step.
5. **Get unread messages (httpRequest)**: The workflow starts or proceeds with this step.
