...
## ⚙️ How It Works
1. **Onfleet Trigger (onfleetTrigger)**: The workflow starts or proceeds with this step.
2. **Discord (discord)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Discord" and "Onfleet Trigger" and update any placeholder IDs, table names, or URLs to match your specific needs.
