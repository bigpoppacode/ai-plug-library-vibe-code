...
## ⚙️ How It Works
1. **Strava (strava)**: The workflow starts or proceeds with this step.
2. **Check Activity Level (if)**: The workflow starts or proceeds with this step.
3. **Enough Activity (noOp)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Strava" and "Check Daily at 11:AM" and update any placeholder IDs, table names, or URLs to match your specific needs.
