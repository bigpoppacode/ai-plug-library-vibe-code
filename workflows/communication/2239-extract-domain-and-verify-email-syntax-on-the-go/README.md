...
2. **Generate random data (debugHelper)**: The workflow starts or proceeds with this step.
3. **Set these fields to extract domain (set)**: The workflow starts or proceeds with this step.
