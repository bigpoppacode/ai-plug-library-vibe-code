...
2. **Get To Dos (notion)**: The workflow starts or proceeds with this step.
3. **If task assigned to Harshil? (if)**: The workflow starts or proceeds with this step.
4. **Create a Direct Message (slack)**: The workflow starts or proceeds with this step.
5. **Send a Direct Message (slack)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Cron" and "Send a Direct Message" and update any placeholder IDs, table names, or URLs to match your specific needs.
