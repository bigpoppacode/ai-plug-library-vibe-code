# New Job Application Parser
  ...
  2. **Sticky Note** `stickyNote` — content: "Automated workflow: New Job Application Parser", height: "530", width: "1100"
3. **Webhook Trigger** `webhook` — method: **POST**, path: `/new-job-application-parser`
...
8. **RAG Agent** `agent` — promptType: "define", text: "Process the following data for task 'New Job Application Parser':
