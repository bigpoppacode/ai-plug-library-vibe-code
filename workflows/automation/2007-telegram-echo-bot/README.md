...
2. **Send back the JSON content of the message (telegram)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Sticky Note" and "Send back the JSON content of the message" and update any placeholder IDs, table names, or URLs to match your specific needs.
