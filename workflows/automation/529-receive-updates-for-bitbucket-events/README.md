...
## ⚙️ How It Works
1. **Bitbucket Trigger (bitbucketTrigger)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Bitbucket Trigger" and "Bitbucket Trigger" and update any placeholder IDs, table names, or URLs to match your specific needs.
