...
2. **Gmail (gmail)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Error Trigger" and "active && no error handler set && not this  handler workflow" and update any placeholder IDs, table names, or URLs to match your specific needs.
