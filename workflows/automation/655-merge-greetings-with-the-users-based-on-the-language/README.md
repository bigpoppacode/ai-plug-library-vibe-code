...
2. **Sample data (name + language) (code)**: The workflow starts or proceeds with this step.
3. **Sample data (greeting + language) (code)**: The workflow starts or proceeds with this step.
4. **Merge (name + language + greeting) (merge)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "When clicking ‘Test workflow’" and "Merge (name + language + greeting)" and update any placeholder IDs, table names, or URLs to match your specific needs.
