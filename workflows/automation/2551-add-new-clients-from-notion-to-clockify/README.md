...
## ⚙️ How It Works
1. **Notion Trigger on new client (notionTrigger)**: The workflow starts or proceeds with this step.
2. **Add client to Clockify (clockify)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Add client to Clockify" and "Sticky Note1" and update any placeholder IDs, table names, or URLs to match your specific needs.
