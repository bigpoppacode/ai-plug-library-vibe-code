...
2. **Strava (strava)**: The workflow starts or proceeds with this step.
3. **Strava1 (strava)**: The workflow starts or proceeds with this step.
4. **Strava2 (strava)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Strava2" and update any placeholder IDs, table names, or URLs to match your specific needs.
