...
2. **Customer Datastore - Generate some data (n8nTrainingCustomerDatastore)**: The workflow starts or proceeds with this step.
3. **Set - Prepare fields (set)**: The workflow starts or proceeds with this step.
4. **Create or Update record in Google Sheet (googleSheets)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Customer Datastore - Generate some data" and update any placeholder IDs, table names, or URLs to match your specific needs.
