...
## ⚙️ How It Works
1. **Request Access Token (httpRequest)**: The workflow starts or proceeds with this step.
2. **Get Userinfo (httpRequest)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Request Access Token" and "Sticky Note7" and update any placeholder IDs, table names, or URLs to match your specific needs.
