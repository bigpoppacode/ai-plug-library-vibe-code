...
## ⚙️ How It Works
1. **Execute "Generate a chart" tool (executeWorkflowTrigger)**: The workflow starts or proceeds with this step.
2. **OpenAI - Generate Chart definition with Structured Output (httpRequest)**: The workflow starts or proceeds with this step.
3. **Set response (set)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "OpenAI Chat Model" and "Text Classifier - Chart required?" and update any placeholder IDs, table names, or URLs to match your specific needs.
