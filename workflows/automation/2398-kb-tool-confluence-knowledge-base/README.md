...
2. **Query Confluence (httpRequest)**: The workflow starts or proceeds with this step.
3. **Return Tool Response (set)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Execute Workflow Trigger" and "Sticky Note5" and update any placeholder IDs, table names, or URLs to match your specific needs.
