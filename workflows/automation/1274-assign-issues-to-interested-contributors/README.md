...
## ⚙️ How It Works
1. **Github Trigger (githubTrigger)**: The workflow starts or proceeds with this step.
2. **Switch (switch)**: The workflow starts or proceeds with this step.
3. **IF no assignee? (if)**: The workflow starts or proceeds with this step.
4. **Assign Issue Creator (github)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Github Trigger" and "Assign Commenter" and update any placeholder IDs, table names, or URLs to match your specific needs.
