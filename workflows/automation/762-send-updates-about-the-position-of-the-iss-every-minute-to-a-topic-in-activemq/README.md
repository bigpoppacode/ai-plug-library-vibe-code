...
4. **AMQP Sender (amqp)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Cron" and "AMQP Sender" and update any placeholder IDs, table names, or URLs to match your specific needs.
