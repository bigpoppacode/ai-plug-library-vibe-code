...
## ⚙️ How It Works
1. **Get latest release (github)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Get latest release" and "List issues" and update any placeholder IDs, table names, or URLs to match your specific needs.
