...
## ⚙️ How It Works
1. **On Error (errorTrigger)**: The workflow starts or proceeds with this step.
2. **Set message (set)**: The workflow starts or proceeds with this step.
3. **Telegram (telegram)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On Error" and "Sticky Note" and update any placeholder IDs, table names, or URLs to match your specific needs.
