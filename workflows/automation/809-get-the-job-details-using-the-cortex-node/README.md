...
2. **Cortex (cortex)**: The workflow starts or proceeds with this step.
3. **Cortex1 (cortex)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Cortex1" and update any placeholder IDs, table names, or URLs to match your specific needs.
