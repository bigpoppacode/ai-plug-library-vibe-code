...
## ⚙️ How It Works
1. **Divide into groups (function)**: The workflow starts or proceeds with this step.
2. **Announce groups (mattermost)**: The workflow starts or proceeds with this step.
3. **Send calendar invites (googleCalendar)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Divide into groups" and "Send calendar invites" and update any placeholder IDs, table names, or URLs to match your specific needs.
