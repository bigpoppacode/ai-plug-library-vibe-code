...
3. **Filter RSS Data (set)**: The workflow starts or proceeds with this step.
4. **Only get new RSS1 (function)**: The workflow starts or proceeds with this step.
5. **Extract Image1 (htmlExtract)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Cron" and "Only get new RSS1" and update any placeholder IDs, table names, or URLs to match your specific needs.
