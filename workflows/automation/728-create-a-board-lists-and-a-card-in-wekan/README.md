...
2. **Wekan (wekan)**: The workflow starts or proceeds with this step.
3. **Wekan1 (wekan)**: The workflow starts or proceeds with this step.
4. **Wekan2 (wekan)**: The workflow starts or proceeds with this step.
5. **Wekan3 (wekan)**: The workflow starts or proceeds with this step.
6. **Wekan4 (wekan)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Wekan4" and update any placeholder IDs, table names, or URLs to match your specific needs.
