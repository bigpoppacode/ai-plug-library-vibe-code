...
## ⚙️ How It Works
1. **Morning reminder (cron)**: The workflow starts or proceeds with this step.
2. **format reminder (functionItem)**: The workflow starts or proceeds with this step.
3. **Send journal reminder (telegram)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Morning reminder" and "Send journal reminder" and update any placeholder IDs, table names, or URLs to match your specific needs.
