...
## ⚙️ How It Works
1. **Request blablagues (httpRequest)**: The workflow starts or proceeds with this step.
2. **Recup image (httpRequest)**: The workflow starts or proceeds with this step.
3. **Tweet image jokes (twitter)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Request blablagues" and "Tweet image jokes" and update any placeholder IDs, table names, or URLs to match your specific needs.
