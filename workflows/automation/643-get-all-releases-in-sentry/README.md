...
2. **Sentry.io (sentryIo)**: The workflow starts or proceeds with this step.
3. **Sentry.io1 (sentryIo)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Sentry.io1" and update any placeholder IDs, table names, or URLs to match your specific needs.
