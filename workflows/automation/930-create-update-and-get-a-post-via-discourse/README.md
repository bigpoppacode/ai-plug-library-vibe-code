...
2. **Discourse (discourse)**: The workflow starts or proceeds with this step.
3. **Discourse1 (discourse)**: The workflow starts or proceeds with this step.
4. **Discourse2 (discourse)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Discourse2" and update any placeholder IDs, table names, or URLs to match your specific needs.
