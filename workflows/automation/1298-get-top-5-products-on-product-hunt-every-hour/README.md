...
2. **GraphQL (graphql)**: The workflow starts or proceeds with this step.
...
5. **Discord (discord)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Cron" and "Discord" and update any placeholder IDs, table names, or URLs to match your specific needs.
