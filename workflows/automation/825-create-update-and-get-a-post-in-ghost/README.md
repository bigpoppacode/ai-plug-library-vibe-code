...
2. **Ghost (ghost)**: The workflow starts or proceeds with this step.
3. **Ghost1 (ghost)**: The workflow starts or proceeds with this step.
4. **Ghost2 (ghost)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Ghost2" and update any placeholder IDs, table names, or URLs to match your specific needs.
