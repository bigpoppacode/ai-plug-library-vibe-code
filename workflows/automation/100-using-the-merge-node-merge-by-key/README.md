...
## ⚙️ How It Works
1. **Data 1 (function)**: The workflow starts or proceeds with this step.
2. **Convert Data 1 (function)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Data 1" and "Merge" and update any placeholder IDs, table names, or URLs to match your specific needs.
