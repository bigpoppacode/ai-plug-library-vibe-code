...
## ⚙️ How It Works
1. **Set (set)**: The workflow starts or proceeds with this step.
2. **Function (function)**: The workflow starts or proceeds with this step.
3. **SendVideo (telegram)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Set" and "SendVideo" and update any placeholder IDs, table names, or URLs to match your specific needs.
