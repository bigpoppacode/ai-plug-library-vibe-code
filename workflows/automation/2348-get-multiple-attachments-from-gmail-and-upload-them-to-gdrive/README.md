...
## ⚙️ How It Works
1. **Trigger - New Email (gmailTrigger)**: The workflow starts or proceeds with this step.
2. **attach binary data outputs (function)**: The workflow starts or proceeds with this step.
3. **upload files to google drive (googleDrive)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Trigger - New Email" and "upload files to google drive" and update any placeholder IDs, table names, or URLs to match your specific needs.
