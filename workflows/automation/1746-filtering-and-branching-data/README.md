...
3. **Country equals US (if)**: The workflow starts or proceeds with this step.
4. **Country is empty or Name contains 'Max' (if)**: The workflow starts or proceeds with this step.
5. **Country based branching (switch)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Country based branching" and update any placeholder IDs, table names, or URLs to match your specific needs.
