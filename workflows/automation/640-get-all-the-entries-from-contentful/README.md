...
2. **Contentful (contentful)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Contentful" and update any placeholder IDs, table names, or URLs to match your specific needs.
