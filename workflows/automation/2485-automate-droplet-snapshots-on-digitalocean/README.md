...
## ⚙️ How It Works
1. **Filter (filter)**: The workflow starts or proceeds with this step.
2. **Delete a Snapshot (httpRequest)**: The workflow starts or proceeds with this step.
3. **Droplet Actions snapshot (n8n.optimus01.co.za) (httpRequest)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Filter" and "Sticky Note15" and update any placeholder IDs, table names, or URLs to match your specific needs.
