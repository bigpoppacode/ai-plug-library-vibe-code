...
## ⚙️ How It Works
1. **publish report (mattermost)**: The workflow starts or proceeds with this step.
2. **Update Post (httpRequest)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "publish report" and "Every hour" and update any placeholder IDs, table names, or URLs to match your specific needs.
