...
## ⚙️ How It Works
1. **Telegram Trigger (telegramTrigger)**: The workflow starts or proceeds with this step.
2. **AWS Textract (awsTextract)**: The workflow starts or proceeds with this step.
3. **AWS S3 (awsS3)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "AWS Textract" and "AWS S3" and update any placeholder IDs, table names, or URLs to match your specific needs.
