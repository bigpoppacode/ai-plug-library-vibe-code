...
## ⚙️ How It Works
1. **OpenAI Chat Model (lmChatOpenAi)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "OpenAI Chat Model" and "When called by Apple Shortcut" and update any placeholder IDs, table names, or URLs to match your specific needs.
