...
4. **msg_greet (telegram)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Switch" and "Run R script" and update any placeholder IDs, table names, or URLs to match your specific needs.
