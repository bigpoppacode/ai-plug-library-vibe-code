...
2. **Check type (if)**: The workflow starts or proceeds with this step.
3. **HTTP Request (httpRequest)**: The workflow starts or proceeds with this step.
4. **Extract Title (htmlExtract)**: The workflow starts or proceeds with this step.
5. **Add Link to Notion (notion)**: The workflow starts or proceeds with this step.
6. **Reply on Discord (set)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Webhook" and "Register URL" and update any placeholder IDs, table names, or URLs to match your specific needs.
