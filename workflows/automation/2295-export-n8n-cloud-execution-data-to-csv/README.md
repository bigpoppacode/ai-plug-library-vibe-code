...
2. **n8n | Get all executions (n8n)**: The workflow starts or proceeds with this step.
3. **Convert to CSV (convertToFile)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "When clicking ‘Test workflow’" and "Sticky Note2" and update any placeholder IDs, table names, or URLs to match your specific needs.
