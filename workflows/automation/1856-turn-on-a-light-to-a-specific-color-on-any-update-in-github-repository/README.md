...
## ⚙️ How It Works
1. **On any update in repository (githubTrigger)**: The workflow starts or proceeds with this step.
2. **Turn a light red (homeAssistant)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On any update in repository" and "Note1" and update any placeholder IDs, table names, or URLs to match your specific needs.
