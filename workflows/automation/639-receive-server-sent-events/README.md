...
## ⚙️ How It Works
1. **SSE Trigger (sseTrigger)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "SSE Trigger" and "SSE Trigger" and update any placeholder IDs, table names, or URLs to match your specific needs.
