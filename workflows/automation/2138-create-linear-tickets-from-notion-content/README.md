...
2. **Fetch Linear team details (graphql)**: The workflow starts or proceeds with this step.
3. **Team missing? (if)**: The workflow starts or proceeds with this step.
4. **Respond with error1 (respondToWebhook)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Loop Over Items" and "Respond with error1" and update any placeholder IDs, table names, or URLs to match your specific needs.
