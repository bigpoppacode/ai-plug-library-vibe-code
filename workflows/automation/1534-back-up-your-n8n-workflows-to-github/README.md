...
2. **Starting Message (slack)**: The workflow starts or proceeds with this step.
3. **n8n (n8n)**: The workflow starts or proceeds with this step.
4. **Loop Over Items (splitInBatches)**: The workflow starts or proceeds with this step.
5. **Completed Notification (slack)**: The workflow starts or proceeds with this step.
