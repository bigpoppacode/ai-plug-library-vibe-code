...
## ⚙️ How It Works
1. **Gmail (gmail)**: The workflow starts or proceeds with this step.
2. **move binary data  (moveBinaryData)**: The workflow starts or proceeds with this step.
3. **write spreadsheet file (spreadsheetFile)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Gmail" and "Note6" and update any placeholder IDs, table names, or URLs to match your specific needs.
