...
3. **Spreadsheet File1 (spreadsheetFile)**: The workflow starts or proceeds with this step.
4. **Move Binary Data (moveBinaryData)**: The workflow starts or proceeds with this step.
5. **Write Binary File (writeBinaryFile)**: The workflow starts or proceeds with this step.
