...
5. **Spreadsheet File (spreadsheetFile)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "HTTP Request" and "Set" and update any placeholder IDs, table names, or URLs to match your specific needs.
