...
## ⚙️ How It Works
1. **@Get Issue (httpRequest)**: The workflow starts or proceeds with this step.
2. **Function (function)**: The workflow starts or proceeds with this step.
3. **IF (if)**: The workflow starts or proceeds with this step.
4. **Discord (discord)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "@Get Issue" and "@Get Date 1 min ago" and update any placeholder IDs, table names, or URLs to match your specific needs.
