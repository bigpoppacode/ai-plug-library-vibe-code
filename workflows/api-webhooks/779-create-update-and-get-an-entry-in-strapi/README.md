...
3. **Strapi (strapi)**: The workflow starts or proceeds with this step.
4. **Set1 (set)**: The workflow starts or proceeds with this step.
5. **Strapi1 (strapi)**: The workflow starts or proceeds with this step.
6. **Strapi2 (strapi)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "On clicking 'execute'" and "Strapi2" and update any placeholder IDs, table names, or URLs to match your specific needs.
