...
## ⚙️ How It Works
1. **Airtable (airtable)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Airtable" and "Per minute" and update any placeholder IDs, table names, or URLs to match your specific needs.
