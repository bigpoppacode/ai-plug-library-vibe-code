...
## ⚙️ How It Works
1. **Mattermost (mattermost)**: The workflow starts or proceeds with this step.
...
3. **Customize Parameters:** Review key nodes like "Mattermost" and "Read data on Google Sheets" and update any placeholder IDs, table names, or URLs to match your specific needs.
